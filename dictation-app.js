(() => {
  ...
  const posLabel = { noun:'名词', verb:'动词', adj:'形容词', adv:'副词', prep:'介词', conj:'连词', det:'限定词/冠词', pron:'代词' };
  function posText(pos){ return posLabel[pos] || '词汇'; }
  ...
  function isVerbMeaning(m){ return /^(使|做|把|将|为|向|与|对)?(放弃|废除|取消|加速|促进|接受|同意|实现|达到|完成|陪伴|伴随|容纳|提供|适应|改编|添加|增加|调整|管理|执行|承认|准许|采用|收养|建议|影响|负担|分析|宣布|道歉|申请|应用|欣赏|感激|评估|联系|联想|假设|尝试|烘烤|禁止|惩罚|记录|认出|打扰|咬|折叠|阻挡|轰炸|预订|提高|广播|燃烧|烧伤|吸收|理解|激活|启动|分配|指派|保证|预料|期望|拍卖|打败|敲打|乞求|打赌|责备|吹|投标|修改|修正|遵守|粘附|积累|获得|习得|提倡|倡导|鼓掌|称赞|任命|安排|存档|出现|似乎|避免|授予|表现|忍受|相信|认为|变成|成为|问|请求|到达|开始|存在|帮助|吸引|附上|连接|允许|参加|出席|攻击|争论|主张|出现|显示|购买|支付|选择|决定|计划|希望|记得|忘记|包括|涉及|支持|发展|占据|占领|排除|扩大|扩展|延伸|创造|生产|减少|增长|改变|改善|保护|讨论|解释|描述|比较|学习|教授|使用|需要|喜欢|观看|听|说|写|阅读|离开|停留|等待|赢|输)/.test(m); }
